...
export const useGraphData = ({ trackSearchQuery = '', focusedArtistId = null } = {}) => {
  ...
  }, [rawData, minPopularity, minGenreCount, activeGenres, maxArtists, showTracks, trackSearchQuery, focusedArtistId])
