...
Dispatch.prototype = dispatch.prototype = {
  ...
  copy: function() {
    var copy3 = {}, _2 = this._;
    for (var t3 in _2) copy3[t3] = _2[t3].slice();
...
function timer(callback, delay2, time2) {
  var t3 = new Timer();
  t3.restart(callback, delay2, time2);
  return t3;
}
function timerFlush() {
  now();
...
function interpolate_default(a3, b10) {
  var c3;
  return (typeof b10 === "number" ? number_default : b10 instanceof color ? rgb_default : (c3 = color(b10)) ? (b10 = c3, rgb_default) : string_default)(a3, b10);
}
...
var polyInOut = function custom3(e3) {
  ...
  function polyInOut2(t3) {
    return ((t3 *= 2) <= 1 ? Math.pow(t3, e3) : 2 - Math.pow(2 - t3, e3)) / 2;
  }
...
function zoom_default2() {
  ...
  zoom2.scaleTo = function(selection2, k2, p2, event) {
    zoom2.transform(selection2, function() {
      var e3 = extent2.apply(this, arguments), t02 = this.__zoom, p0 = p2 == null ? centroid(e3) : typeof p2 === "function" ? p2.apply(this, arguments) : p2, p1 = t02.invert(p0), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
  ...
  zoom2.filter = function(_2) {
    return arguments.length ? (filter4 = typeof _2 === "function" ? _2 : constant_default3(!!_2), zoom2) : filter4;
  };
  ...
  zoom2.extent = function(_2) {
    return arguments.length ? (extent2 = typeof _2 === "function" ? _2 : constant_default3([[+_2[0][0], +_2[0][1]], [+_2[1][0], +_2[1][1]]]), zoom2) : extent2;
  };
...
function blurf(radius) {
  ...
  return (T2, S2, start2, stop, step) => {
    ...
    for (let i2 = start2, j2 = stop; i2 <= j2; i2 += step) {
      ...
      T2[i2] = (sum3 + t3 * (S2[Math.max(start2, i2 - s1)] + S2[Math.min(stop, i2 + s1)])) / w2;
...
function shuffler(random2) {
  return function shuffle2(array3, i0 = 0, i1 = array3.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i2 = random2() * m3-- | 0, t3 = array3[m3 + i0];
...
var constant_default4 = constant2;
...
function L(n2, l2, u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  ...
  for (f2 = T(u2, l2, m3, f2, b10), s2 = 0; s2 < b10; s2++) null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c3, a3), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a3.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
...
function q(n2, u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  var s2, h2, p2, v2, y3, d2, _2, k2, x3, M, $2, I2, P2, A2, H2, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t3.__u && (c3 = !!(32 & t3.__u), o2 = [f2 = u2.__e = t3.__e]), (s2 = l.__b) && s2(u2);
  n: if ("function" == typeof T2) try {
    if (k2 = u2.props, x3 = T2.prototype && T2.prototype.render, M = (s2 = T2.contextType) && i2[s2.__c], $2 = s2 ? M ? M.props.value : s2.__ : i2, t3.__c ? _2 = (h2 = u2.__c = t3.__c).__ = h2.__E : (x3 ? u2.__c = h2 = new T2(k2, $2) : (u2.__c = h2 = new C(k2, $2), h2.constructor = T2, h2.render = Q), M && M.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), x3 && null == h2.__s && (h2.__s = h2.state), x3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = m({}, h2.__s)), m(h2.__s, T2.getDerivedStateFromProps(k2, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) x3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), x3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = m(m({}, i2), h2.getChildContext())), x3 && !p2 && null != h2.getSnapshotBeforeUpdate && (d2 = h2.getSnapshotBeforeUpdate(v2, y3)), A2 = null != s2 && s2.type === S && null == s2.key ? E(s2.props.children) : s2, f2 = L(n2, g(A2) ? A2 : [A2], u2, t3, i2, r2, o2, e3, f2, c3, a3), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), _2 && (h2.__E = h2.__ = null);
  } catch (n3) {
...
function G(u2, t3, i2, r2, o2, e3, f2, c3, a3) {
  ...
  if (null == u2) {
    ...
    u2 = document.createElementNS(o2, x3, k2.is && k2), c3 && (l.__m && l.__m(t3, e3), c3 = false), e3 = null;
  }
  if (null == x3) m3 === k2 || c3 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = "textarea" == x3 && null != k2.defaultValue ? null : e3 && n.call(u2.childNodes), !c3 && null != e3) for (m3 = {}, s2 = 0; s2 < u2.attributes.length; s2++) m3[(y3 = u2.attributes[s2]).name] = y3.value;
    ...
    for (s2 in k2) y3 = k2[s2], "children" == s2 ? v2 = y3 : "dangerouslySetInnerHTML" == s2 ? h2 = y3 : "value" == s2 ? w2 = y3 : "checked" == s2 ? _2 = y3 : c3 && "function" != typeof y3 || m3[s2] === y3 || N(u2, s2, y3, m3[s2], o2);
    if (h2) c3 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c3, a3), null != e3) for (s2 = e3.length; s2--; ) b(e3[s2]);
...
function R(u2, t3, i2) {
  var r2, o2, e3, f2;
  t3 == document && (t3 = document.documentElement), l.__ && l.__(u2, t3), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t3.__k, e3 = [], f2 = [], q(t3, u2 = (!r2 && i2 || t3).__k = k(S, null, [u2]), o2 || d, d, t3.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t3.firstChild ? n.call(t3.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t3.firstChild, r2, f2), D(e3, u2, f2);
}
function W(l2, u2, t3) {
...
function link_default(links) {
  var id2 = index6, strength = defaultStrength, strengths, distance2 = constant_default5(30), distances, nodes, nDim, count2, bias, random2, iterations = 1;
  if (links == null) links = [];
...
var utils = {
  ...
  compute: function(t3, points, _3d) {
    ...
    if (order < 4) {
      let mt2 = mt * mt, t22 = t3 * t3, a3, b10, c3, d2 = 0;
      if (order === 2) {
      ...
      const ret = {
        x: a3 * p2[0].x + b10 * p2[1].x + c3 * p2[2].x + d2 * p2[3].x,
        y: a3 * p2[0].y + b10 * p2[1].y + c3 * p2[2].y + d2 * p2[3].y,
        t: t3
      };
      if (_3d) {
        ret.z = a3 * p2[0].z + b10 * p2[1].z + c3 * p2[2].z + d2 * p2[3].z;
      }
      return ret;
    }
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a4 = aligned[0].y, b11 = aligned[1].y, c4 = aligned[2].y, d3 = a4 - 2 * b11 + c4;
      if (d3 !== 0) {
        const m1 = -sqrt(b11 * b11 - a4 * c4), m22 = -a4 + b11, v12 = -(m1 + m22) / d3, v2 = -(-m1 + m22) / d3;
        return [v12, v2].filter(reduce3);
      } else if (b11 !== c4 && d3 === 0) {
        return [(2 * b11 - c4) / (2 * b11 - 2 * c4)].filter(reduce3);
      }
      return [];
    }
    const pa = aligned[0].y, pb = aligned[1].y, pc = aligned[2].y, pd = aligned[3].y;
    let d2 = -pa + 3 * pb - 3 * pc + pd, a3 = 3 * pa - 6 * pb + 3 * pc, b10 = -3 * pa + 3 * pb, c3 = pa;
    if (utils.approximately(d2, 0)) {
      if (utils.approximately(a3, 0)) {
        if (utils.approximately(b10, 0)) {
          return [];
        }
        return [-c3 / b10].filter(reduce3);
      }
      const q3 = sqrt(b10 * b10 - 4 * a3 * c3), a22 = 2 * a3;
      return [(q3 - b10) / a22, (-b10 - q3) / a22].filter(reduce3);
    }
    a3 /= d2;
    b10 /= d2;
    c3 /= d2;
    const p2 = (3 * b10 - a3 * a3) / 3, p3 = p2 / 3, q2 = (2 * a3 * a3 * a3 - 9 * a3 * b10 + 27 * c3) / 27, q22 = q2 / 2, discriminant = q22 * q22 + p3 * p3 * p3;
    let u1, v1, x1, x22, x3;
    if (discriminant < 0) {
      const mp3 = -p2 / 3, mp33 = mp3 * mp3 * mp3, r2 = sqrt(mp33), t3 = -q2 / (2 * r2), cosphi = t3 < -1 ? -1 : t3 > 1 ? 1 : t3, phi = acos(cosphi), crtr = crt(r2), t12 = 2 * crtr;
      x1 = t12 * cos(phi / 3) - a3 / 3;
      x22 = t12 * cos((phi + tau2) / 3) - a3 / 3;
      x3 = t12 * cos((phi + 2 * tau2) / 3) - a3 / 3;
  ...
  droots: function(p2) {
    if (p2.length === 3) {
      const a3 = p2[0], b10 = p2[1], c3 = p2[2], d2 = a3 - 2 * b10 + c3;
      if (d2 !== 0) {
        const m1 = -sqrt(b10 * b10 - a3 * c3), m22 = -a3 + b10, v1 = -(m1 + m22) / d2, v2 = -(-m1 + m22) / d2;
        return [v1, v2];
      } else if (b10 !== c3 && d2 === 0) {
        return [(2 * b10 - c3) / (2 * (b10 - c3))];
      }
      return [];
    }
    if (p2.length === 2) {
  ...
  inflections: function(points) {
    ...
    const p2 = utils.align(points, { p1: points[0], p2: points.slice(-1)[0] }), a3 = p2[2].x * p2[1].y, b10 = p2[3].x * p2[1].y, c3 = p2[1].x * p2[2].y, d2 = p2[3].x * p2[2].y, v1 = 18 * (-3 * a3 + 2 * b10 + 3 * c3 - d2), v2 = 18 * (3 * a3 - b10 - 3 * c3), v3 = 18 * (c3 - a3);
...
var Bezier = class _Bezier {
  ...
  project(point2) {
    const LUT = this.getLUT(), l2 = LUT.length - 1, closest = utils.closest(LUT, point2), mpos = closest.mpos, t12 = (mpos - 1) / l2, t22 = (mpos + 1) / l2, step = 0.1 / l2;
    let mdist = closest.mdist, t3 = t12, ft = t3, p2;
    mdist += 1;
  ...
  split(t12, t22) {
    ...
    result2.left._t2 = utils.map(t12, 0, 1, this._t1, this._t2);
    result2.right._t1 = utils.map(t12, 0, 1, this._t1, this._t2);
  ...
  reduce() {
    let i2, t12 = 0, t22 = 0, step = 0.01, segment, pass1 = [], pass2 = [];
    ...
    for (t12 = extrema[0], i2 = 1; i2 < extrema.length; i2++) {
      t22 = extrema[i2];
...
function locale_default(locale3) {
  ...
  function newFormat(specifier, options) {
    ...
    var fill2 = specifier.fill, align = specifier.align, sign = specifier.sign, symbol = specifier.symbol, zero2 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim2 = specifier.trim, type = specifier.type;
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i2 = -1, j2 = 0, n2 = specifier.length, c3, pad4, format2;
      if (!(date instanceof Date)) date = /* @__PURE__ */ new Date(+date);
      while (++i2 < n2) {
        if (specifier.charCodeAt(i2) === 37) {
          string.push(specifier.slice(j2, i2));
          if ((pad4 = pads[c3 = specifier.charAt(++i2)]) != null) c3 = specifier.charAt(++i2);
          else pad4 = c3 === "e" ? " " : "0";
          if (format2 = formats2[c3]) c3 = format2(date, pad4);
          string.push(c3);
          j2 = i2 + 1;
        }
      }
  ...
  function parseSpecifier(d2, specifier, string, j2) {
    var i2 = 0, n2 = specifier.length, m3 = string.length, c3, parse;
    while (i2 < n2) {
      if (j2 >= m3) return -1;
...
function _defineProperty3(e3, r2, t3) {
